...
Examples:
    ...
    python scripts/train_mappo_ffn.py --experiment action_penalty --resume-run run_20260131143045

    # Resume from a run at a specific curriculum level
    python scripts/train_mappo_ffn.py --experiment action_penalty --resume-run run_20260131143045 --curriculum-level 5
        """,
    )
    ...
    parser.add_argument("--resume-run", type=str, default=None,
                        help="Run name (e.g., 'run_20260131143045') or full path to resume from")
