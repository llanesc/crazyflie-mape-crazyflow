#!/usr/bin/env python3
"""Sweep --override-mass for blue 1 and blue 2 over a mesh and collect blue win rates (ACMPC)."""
...
OUTPUT_CSV = f"results/acmpc/{EXPERIMENT}/results/{CHECKPOINT}/mass_sweep_acmpc.csv"

# Eval command template
BASE_CMD = [
    sys.executable, "scripts/eval_mappo_acmpc.py",
