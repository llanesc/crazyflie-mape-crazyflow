#!/usr/bin/env python3
"""Sweep --override-mass for blue 1 and blue 2 over a mesh and collect blue win rates."""
...
OUTPUT_CSV = "results/acmpc/action_penalty/mass_sweep.csv"
